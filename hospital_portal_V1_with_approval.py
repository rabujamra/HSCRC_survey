...
# ==================== PAGE CONFIG ====================
st.set_page_config(
    page_title="HSCRC Best Practices - Unified Portal",
    page_icon="🏥",
    layout="wide",
...
# Hospital credentials (DEMO - Replace with real auth system)
HOSPITAL_CREDS = {
...
def get_hospital_submission(hospital_name):
    """Get the latest submission for a hospital"""
    df = load_data()
    if df.empty:
        return None
...
def render_bp1_questions(tier, prefix, existing_data=None):
    ...
    # 🚨 NEW: Target/Actual for KPI 5 & 6 in Tier 3
    if kpi5:
