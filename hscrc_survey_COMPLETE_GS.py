...
from google_sheets_connector import append_row_to_sheets
...
# ==================== CONSTANTS ====================
# No longer using CSV - data is stored in Google Sheets!
...
if not st.session_state.submitted:
    ...
    if st.button("✅ Submit Survey"):
        ...
        with st.spinner("Saving your submission to Google Sheets..."):
            success = append_row_to_sheets(data)
